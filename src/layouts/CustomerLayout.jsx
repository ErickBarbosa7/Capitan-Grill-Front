...
import { Menu, Info, Share2, Flame, Award, Clock } from 'lucide-react';
import MenuTab from '../components/MenuTab/MenuTab';
import bgImg from '../assets/img/Lugar.jpg';
...
export default function CustomerLayout() {
  ...
  useEffect(() => {
    const checkDesktop = () => {
      ...
      if (desktop && !location.pathname.startsWith('/menu')) {
    ...
    return (
      <div className={styles.desktopView}>
        <aside className={styles.leftPanel}>
          <div className={styles.leftPanelBg} style={{ backgroundImage: `url(${bgImg})` }} />
          ...
          <div className={styles.leftPanelContent}>
            ...
            <div className={styles.heroSection}>
              ...
              <p className={styles.heroDesc}>
                Cortes finos a la parrilla, servidos en un entorno rústico que celebra el sabor del norte.
              </p>
              <div className={styles.heroActions}>
                <button className={styles.btnPrimary} onClick={() => scrollTo('menu')}>
                  Ver Menú
                </button>
                <button className={styles.btnSecondary} onClick={() => scrollTo('nosotros')}>
                  Nuestra Historia
                </button>
              </div>
            </div>
            ...
            <div className={styles.featureCards}>
              <div className={styles.card}>
                <div className={styles.cardIcon}><Flame size={20} /></div>
                <h4 className={styles.cardTitle}>De la Granja al Fuego</h4>
                <p className={styles.cardText}>Seleccionamos los mejores cortes directamente del campo a tu mesa.</p>
              </div>
              <div className={styles.card}>
                <div className={styles.cardIcon}><Award size={20} /></div>
                <h4 className={styles.cardTitle}>Maestros Parrilleros</h4>
                <p className={styles.cardText}>Técnica y tradición en cada término, ejecutada por expertos.</p>
              </div>
              <div className={styles.card}>
                <div className={styles.cardIcon}><Clock size={20} /></div>
                <h4 className={styles.cardTitle}>Siempre Caliente</h4>
                <p className={styles.cardText}>Servicio impecable, directo de la parrilla a tu plato.</p>
              </div>
            </div>
