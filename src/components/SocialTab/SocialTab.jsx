...
const WHATSAPP_URL = 'https://wa.me/522216029780?text=Hola!%20Quisiera%20informes';
const INSTAGRAM_URL = '#';
    ...
    <div className={styles.wrapper}>
      <section className={styles.section}>
        ...
        <p className={styles.description}>
          Visítanos en Facebook para ver fotos, promociones y novedades de Capitán Grill.
        </p>
